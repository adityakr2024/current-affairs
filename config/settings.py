...
FULL_ARTICLES_PER_RUN    = 20    # Target article count for PDF and social posts
MIN_ARTICLES_PER_RUN     = 8     # Minimum acceptable — system still runs below target
QUICK_BITES_PER_RUN      = 12    # Target quick-bite one-liner count
MIN_ONELINERS_PER_RUN    = 5     # Minimum acceptable
FILTER_SCORE_THRESHOLD   = 10    # Min score to pass filter
